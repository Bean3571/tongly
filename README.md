...
Взаимодействие компонентов (Есть возможность использовать https с использованием сертификатов пока что только для localhost, поээтому в схеме указан http)
